# this script is used for abstract classs of the character motion learning enviornments
import sys
import os
import operator
...
class BaseTask():
    ...
    def __init__(self, cfg, enable_camera_sensors=False):
        ...
        self.headless = cfg["headless"] # whether to render the scene
        ...
        self.num_obs = cfg["env"]["numObservations"] # the dimensions of the observation space
        ...
        self.original_props = {}
        self.dr_randomizations = {} # what is this ????
        ...
        self.create_sim()
        self.gym.prepare_sim(self.sim) # use GPU API
    ...
    def create_sim(self, compute_device, graphics_device, physics_engine, sim_params):
        #create the simulatoin environment
